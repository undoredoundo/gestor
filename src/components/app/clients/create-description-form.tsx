...
import { createDescriptionSchema } from "@/lib/schemas";
...
export default function CreateDescriptionForm({
  ...
  const mutation = useMutation(
    trpc.clients.createDescription.mutationOptions(),
  );
  ...
  async function handleSubmit(values: z.infer<typeof createDescriptionSchema>) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Crear Descripción</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
